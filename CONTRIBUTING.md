# Contributing to Rancher Gitlab Deploy

:+1: :tada: First off, thanks for taking the time to contribute! :tada: :+1:

The following is a set of guidelines for contributing to Rancher Gitlab Deploy. These are mostly guidelines, not rules. Use your best judgment, and feel free to propose changes to this document in a pull request.
...
This project and everyone participating in it is governed by the [Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to [kemsar@pm.me](mailto:kemsar@pm.me).
...
When we make a significant decision in how we maintain the project and what we can or cannot support, we will document it. If you have a question around how we do things, check to see if it is documented. If it is *not* documented there, please ask your question.
